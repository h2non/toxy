...
RockyBase.prototype.disable = function (poison) {
  return this._callMethod(this._poisons.stack, 'disable', poison)
}

RockyBase.prototype.enable = function (poison) {
  return this._callMethod(this._poisons.stack, 'enable', poison)
}

RockyBase.prototype.isPoisonEnabled = function (poison) {
  return this._callMethod(this._poisons.stack, 'isEnabled', poison)
}

RockyBase.prototype.poisons =
RockyBase.prototype.getPoisons = function () {
  return this._getAll(this._poisons.stack)
}
